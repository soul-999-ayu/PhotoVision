...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (visionixLink) {
        visionixLink.href = "product-categories/applanation%20-tonometer-hongdee/index.html"; // Replace with your new URL
    }
});
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const newCategory = {
            ...
            products: [{
                ...
                name: 'Ophthalmic Motorized Table',
                href: 'our-products/diagnostic-three/index.html'
            },
            {
